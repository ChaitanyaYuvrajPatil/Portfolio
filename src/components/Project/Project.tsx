        ...
        <ScrollAnimation animateIn="bounceInDown">
          <div className="project">
            ...
            <div className="body">
              <h3>Meeting Web</h3>
              <p>
                Developed Meeting Web, a multifaceted platform enabling dynamic
                interaction between attendees, reviewers, and admins within a
                meeting and event management ecosystem.
              </p>
              <p>
                Leveraged ReactJS for building a responsive and interactive
                frontend, combined with Material-UI for an aesthetically
                pleasing and user-friendly interface.
              </p>
              <p>
                Contributed to a scalable and maintainable codebase, adhering to
                best practices in software development and agile methodologies.{" "}
              </p>
              <p>Tech Used :- ReactJS, Material-UI (MUI)</p>
            </div>
            <footer>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/SIH2022/aimouse"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>No Touch</h3>
              <p>
                To create a software that for any user, authenticated by face
                recognition, few gestures could be defined for frequently used
                tasks- save, exit, print, screen-lock, screen unlock, system
                shut down, system restart.{" "}
              </p>
              <p>Tech Used : Python, OpenCV, Tensorflow, MediaPipe, MongoDB</p>
            </div>
            <footer>
              <div className="social-media">
        ...
        <ScrollAnimation animateIn="bounceInDown">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ChaitanyaYuvrajPatil/Blood-Camp-Management"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />{" "}
            ...
            <div className="body">
              <h3>Blood Camp Management System</h3>
              <p>
                Python and SQL based project involving many functionality like
                Admin Login, Volunteer Registration, Create Certificate
              </p>
              <p>
                Admin can approve Volunteer and Send Certificate via Gmail. For
                Volunteer and Donar section having functionality of ,Add,
                Update,Delete and clear user data
              </p>
              <p>Tech Used : Python, SQL, PyQT5</p>
            </div>
